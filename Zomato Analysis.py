...
df_data = pd.read_csv(r"C:\Python projects\Zomato-Analysis-with-Python\Zomato-Analysis-with-Python-and-visualization-with-Power-BI-main\Zamoto raw data\zomato.csv", encoding='unicode_escape')
print(df_data)


# Loading excel file of country code using pandas

df_country = pd.read_excel(r"C:\Python projects\Zomato-Analysis-with-Python\Zomato-Analysis-with-Python-and-visualization-with-Power-BI-main\Zamoto raw data\Country-Code.xlsx")
print(df_country)
